...
<link href="{{asset('css/QR-css/bootstrap.min.css')}}" rel="stylesheet">
<link href="{{asset('css/QR-css/style.css')}}" rel="stylesheet">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <body>
                            ...
                            <script src="{{asset('js/QR-reader/filereader.js')}}"></script>
                            <script type="text/javascript" src="{{asset('js/QR-reader/jquery.js')}}"></script>
                            <script type="text/javascript" src="{{asset('js/QR-reader/qrcodelib.js')}}"></script>
                            <script type="text/javascript" src="{{asset('js/QR-reader/webcodecamjquery.js')}}"></script>
                            <script type="text/javascript" src="{{asset('js/QR-reader/mainjquery.js')}}"></script>
                            <script src="{{asset('js/QR-reader/qrcodelib.js')}}"></script>
                            <script src="{{asset('js/QR-reader/webcodecamjs.js')}}"></script>
...
function AddQuantity(QtyCode=''){
let url = "{{route('product.add-qty-by-qr-code')}}";
const dataoffice = { 'qtycode' : QtyCode };
    if(QtyCode != ''){
        console.log(QtyCode);
        $.ajax({
            method : 'get',
